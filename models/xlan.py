...
class XLAN(AttBasicModel):
    def __init__(self):
        ...
        self.attention = blocks.create(
            ...
            geo_dim=cfg.MODEL.GEO_DIM,  # Add geo_dim to the attention block creation
    ...
    def Forward(self, **kwargs):
        ...
        geo_feats = kwargs[cfg.PARAM.GEO_FEATS]  # Add geo_feats to the forward parameters
        gv_feat = kwargs[cfg.PARAM.GLOBAL_FEAT]
        p_att_feats = kwargs[cfg.PARAM.P_ATT_FEATS]
        #print(f"XLAN geo_feats in Forward: {geo_feats}")  # Debug statement
        ...
        att, _ = self.attention(h_att, att_feats, att_mask, geo_feats, p_att_feats, precompute=True)  # Pass geo_feats
