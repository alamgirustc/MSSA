...
__C.DATA_LOADER.GEO_FEATS_FOLDER = 'gdata/Alamgir/mscoco/feature/deep_feats/geo_feats'  # Updated path
...
__C.INFERENCE.COCO_PATH = '/ghome/Alamgir/LSTM_s1290L20g/coco_caption'
...
__C.SEED = -1.0
__C.TEMP_DIR = '/ghome/Alamgir/LSTM_s1290L20g/data/temp'
